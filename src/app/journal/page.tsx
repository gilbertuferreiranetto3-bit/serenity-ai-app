    ...
    <div className="min-h-screen bg-gradient-serenity flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="card-spa p-8 text-center">
          <div className="w-20 h-20 bg-gradient-to-r from-serenity-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-6">
            <Lock className="w-10 h-10 text-white" />
          </div>
          
          <h1 className="text-2xl font-bold text-spa-900 dark:text-spa-50 mb-3">
            Diário Emocional - Em Breve
          </h1>
          
          <p className="text-spa-600 dark:text-spa-400 mb-6">
            Esta funcionalidade será implementada no <strong>Módulo 4</strong>.
          </p>
          ...
          <div className="bg-serenity-50 dark:bg-serenity-900/30 border border-serenity-300 dark:border-serenity-700 rounded-xl p-4 mb-6 text-left">
            ...
            <ul className="text-sm text-spa-600 dark:text-spa-400 mt-2 space-y-1">
              ...
              <li>• Gráficos de humor (semanal/mensal)</li>
              <li>• Exportar em PDF/JSON</li>
            </ul>
          </div>
